...
import programs.cdag16.bell as cdag16_bell
# 加入 cdag16 模組下的 man.py 且以子模組 man 對應其 BELL() 類別
root.cdag16.bell = cdag16_bell.BELL()

# 完成設定後, 可以利用
/cdag16/bell/assembly
# 呼叫 bell.py 中 BELL 類別的 assembly 方法
'''
class BELL(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
這是 2014CDA 協同專案下的 cdag16 模組下的 BELL 類別.<br /><br />
<!-- 這裡採用相對連結, 而非網址的絕對連結 (這一段為 html 註解) -->
<a href="assembly">執行  BELL 類別中的 assembly 方法</a><br /><br />
請確定下列零件於 V:/home/dumbbell 目錄中, 且開啟空白 Creo 組立檔案.<br />
